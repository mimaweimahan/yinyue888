...
<div class="panel-default">
    <div class="panel-heading">
        ...
        <ul class="panel-tab">
            ...
            <li id="add_rule"><a href="{:url('add')}">新增单页</a></li>
        </ul>
    </div>
...
<script type="text/html" id="title_panel">
    <a href="{:url('edit')}?id={{ d.id }}"> {{ d.title }} </a>
</script>

<script type="text/html" id="url_panel">
    <a> /pages/page?label={{ d.label }} </a>
</script>
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'sort', title: '排序', width:90,toolbar: '#sort_panel',sort: true}
                ,{field: 'title', title: '单页名称', width:160, toolbar: '#title_panel', sort: true}
                ,{field: 'label', title: '调用标识', width:120, sort: true}
                ,{field: 'url', title: '小程序地址', width:220, toolbar: '#url_panel', sort: true}
                ,{field: 'status', title: '状态', width:90, toolbar: '#status_panel', sort: true}
