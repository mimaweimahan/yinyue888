...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-lead"><em>分类管理</em></div>
        <ul class="panel-tab">
            <li><a href="{:url('index')}">列表</a></li>
            <li class="layui-this"><a href="javascript:void(0);">编辑</a></li>
        </ul>
    </div>
        ...
        <form class="layui-form" method="post" action="{:url('edit')}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" value="{$name}" id="name" class="layui-input" size="68" placeholder="请填写分类名称">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div><input type="text" name="image" value="{$image}" id="image" placeholder="菜单图标" class="layui-input"></div>
                    <br/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 120px;">
                    <div class="color-picker-box">
                        <input type="text" name="color" value="{$color}" placeholder="请选择颜色" class="layui-input" id="color">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="url" value="{$url}" id="url" class="layui-input" size="68" placeholder="请填写菜单地址">
                </div>
            </div>
