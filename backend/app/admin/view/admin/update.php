    ...
    <div class="panel-body">
        <div class="layui-show">
            ...
            <form class="layui-form" method="post" action="{:url('edit')}">
                ...
                <div class="layui-form-item">
                    <label for="nickname" class="layui-form-label">用户名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="nickname" value="{$nickname}" id="nickname" placeholder="用户名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="email" class="layui-form-label">登录邮箱</label>
                    <div class="layui-input-block">
                        <input type="text" name="email" value="{$email}" id="email" placeholder="登录账号" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="phone" class="layui-form-label">登录手机号</label>
                    <div class="layui-input-block">
                        <input type="text" name="phone" value="{$phone}" id="phone" placeholder="手机号" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
