            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-xs4">
                    <label class="relative block">
                        ...
                        <input type="password" name="password" value="abc123"   placeholder="请输入登录密码" class="layui-input">
                        <span class="color-desc">默认密码：abc123</span>
                    </label>
                </div>
                <div class="layui-col-xs4">
                    <label class="relative block">
                        ...
                        <input type="text" name="trans_password" value="123123" autocomplete="off" placeholder="请输入交易密码" class="layui-input">
                        <span class="color-desc">默认密码：123123</span>
                    </label>
                </div>
                <div class="layui-col-xs4">
                    <label class="relative block">
