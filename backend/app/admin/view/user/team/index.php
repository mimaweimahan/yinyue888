...
<div class="panel-default">
    <div class="panel-heading">
        ...
        <ul class="panel-tab">
            <li class="layui-this"><a> 团队管理</a></li>
            <li><a href="{:url('admin/user.relation/index')}"> 推荐关系 </a></li>
        </ul>
    </div>
...
<script type="text/html" id="order_num_tpl">
    自己：<a href="{:url('group/admin.order/index')}?uid={{ d.uid }}">{{ d.my_order_num }}单</a>
    <br />
...
<script type="text/html" id="toolbar">
    ...
    <div class="grade_box">
        <select name="grade_select" class="layui-select">
            {volist name="grade_list" id="r"}
            <option value="{$r['id']}">{$r['grade_name']}</option>
            {/volist}
        </select>
        <a class="layui-btn" lay-event="set">设置等级</a>
    </div>
</script>
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'grade_name', title:'会员等级', width:120, align: 'center'}
                ,{field: 'amount', title:'余额', width:100, sort:true, align: 'center'}
                ,{field: 'referee_name', title:'推荐人', width:100, templet: '#referee_panel'}
