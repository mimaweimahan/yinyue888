...
<head>
    ...
    <title>{if !empty($id)}编辑APP下载链接{else}添加APP下载链接{/if}</title>
    ...
    <form class="layui-form" method="post" action="{if !empty($id)}{:url('edit')}{else}{:url('add')}{/if}">
        ...
        <div class="form-item">
            ...
            <div class="input-block">
                <input type="text" name="url" value="{$url|default=''}" id="url" placeholder="请输入完整的下载链接，如：https://example.com/app.apk" autocomplete="off" class="layui-input" lay-verify="required" />
            </div>
        </div>
