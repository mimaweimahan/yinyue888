...
<script type="text/html" id="title_panel">
    <a href="{:url('type')}?pid={{ d.id }}"> {{ d.type_name }} </a>
</script>

<script type="text/html" id="set_panel">
    <a href="{:url('type')}?pid={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-primary">子类管理</a>
...
<script type="text/html" id="toolbar">
    <div class="layui-btn-container">
        <div class="layui-btn-group">
            <a class="layui-btn layui-btn-sm" lay-event="add_btn">
                {if $pid>0}
                <span><i class="layui-icon layui-icon-add-circle"></i>新增 [{$p_name}] 子类</span>
                {else/}
                <span><i class="layui-icon layui-icon-add-circle"></i>新增</span>
                {/if}
            </a>
        </div>
        <div class="layui-btn-group">
...
<script type="text/javascript">
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[ //表头
                {type: 'checkbox'}
                ,{title: '管理操作', width:220, align: 'center', toolbar: '#set_panel'}
                ,{field: 'sort', title: '排序', width:100,toolbar: '#sort_panel',sort: true}
                ,{field: 'type_name', title: '分类名称', minWidth:140,toolbar: '#title_panel', sort: true}
            ]]
        });
