    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'name', title: '文件名称', width:150,toolbar: '#name_panel'}
                ...
                ,{field: 'app', title: '所属应用', width:120}
                ,{field: 'url', title: '访问地址', nimWidth:200}
                ,{field: 'create_time', title: '上传时间', width:120, sort: true}
