        ...
        <form class="layui-form" method="post" action="{:url('edit')}">
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <input type="text" name="name" id="name" class="layui-input" size="60" value="{$data['name']}" />
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <input type="text" name="title" id="title" class="layui-input" size="60" value="{$data['title']}" />
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <input type="text" name="sort" id="sort" class="layui-input" value="{$data['sort']}" />
            ...
            <div class="form-item">
                ...
                <div>
                    <select name="type" id="type" class="layui-input w-auto" style="min-width: 120px;">
                        {foreach $config_type_list as $key=>$val }
                        {if $data['type'] == $key}
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <textarea name="value" id="value" rows="5" cols="60"  class="layui-textarea">{$data['value']}</textarea>
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <textarea name="extra" id="extra" rows="5" cols="60" class="layui-textarea">{$data['extra']}</textarea>
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <textarea name="remark" id="remark" rows="5" cols="60" class="layui-textarea">{$data['remark']}</textarea>
