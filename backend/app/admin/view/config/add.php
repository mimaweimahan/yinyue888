...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-lead"><em>新增配置</em></div>
    </div>
    ...
    <form class="layui-form" method="post" action="{:url('add')}">
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="name" id="name" class="layui-input" size="68" placeholder="只能使用英文且不能重复" value="">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="title" id="title" size="68" class="layui-input">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="sort" id="sort" class="layui-input"  placeholder="用于分组显示的顺序" value="">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <textarea name="value" id="value" rows="5" cols="60"  placeholder="配置值" class="layui-textarea"></textarea>
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <textarea name="extra" id="extra" rows="5" cols="60" placeholder="如果是枚举型 需要配置该项" class="layui-textarea"></textarea>
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <textarea name="remark" id="remark" rows="5" cols="60" placeholder="配置详细说明" class="layui-textarea"></textarea>
