...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-lead"><em>编辑商品</em></div>
    </div>
        ...
        <form class="layui-form" method="post" action="{:url('edit')}">
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <input type="text" name="title" id="title" class="layui-input" value="{$title}" size="68" placeholder="请填写商品名称">
                </div>
            </div>
            <div class="form-item">
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <input type="text" name="image" value="{$image}" id="image" class="layui-input w100" placeholder="点击右侧按钮上传">
                </div>
            ...
            <div class="form-item">
                ...
                <div class="input-inline">
                    <input type="text" name="price" value="{$price}" id="price" class="layui-input" placeholder="请输入产品价格">
                </div>
            </div>
            <div class="form-item">
                <label class="form-label" for="daily_sale">日销售额：</label>
                <div class="input-inline">
                    <input type="text" name="daily_sale" value="{$daily_sale}"  id="daily_sale" class="layui-input" placeholder="0">
                </div>
            </div>
            <div class="form-item">
                <label class="form-label" for="total_sales">日销售额：</label>
                <div class="input-inline">
                    <input type="text" name="total_sales" value="{$total_sales}" id="total_sales" class="layui-input" placeholder="0">
                </div>
            </div>
            <div class="form-item">
                <label class="form-label" for="incr_rate">日增长率：</label>
                <div class="input-inline">
                    <input type="text" name="incr_rate" value="{$incr_rate}" id="incr_rate" class="layui-input" placeholder="0">
                </div>
            </div>
            <div class="form-item">
                <label class="form-label" for="product_id">第三方产品ID：</label>
                <div class="input-inline">
                    <input type="text" name="product_id" value="{$product_id}" id="product_id" class="layui-input" placeholder="0">
                </div>
            </div>
            <div class="form-item">
                <label class="form-label" for="content">商品描述</label>
                <div class="input-inline">
                    <textarea name="content" id="content">{$content|raw}</textarea>
                </div>
            </div>
