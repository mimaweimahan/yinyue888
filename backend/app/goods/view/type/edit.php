...
<div class="page-package">
    <form class="layui-form" method="post" action="{:url('edit')}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" class="layui-input" value="{$type_name}" placeholder="请填类别名称" title="请填类别名称" />
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label" for="image_pic">分类图片</label>
            <div class="layui-input-block">
                <div><input type="text" name="image" value="{$image}" id="image_pic" placeholder="分类图片" class="layui-input"></div>
                <br/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 120px;">
                <div class="color-picker-box">
                    <input type="text" name="color" placeholder="请选择颜色" value="{$color}" class="layui-input" id="color">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="show" value="1" title="开启" {eq name="$show" value="1"} checked {/eq} />
                <input type="radio" name="show" value="0" title="关闭" {eq name="$show" value="0"} checked {/eq} />
            </div>
        </div>
        <div class="footer-btn-box">
            <div>
                <button type="submit" class="layui-btn" lay-submit lay-filter="submit_btn">提交编辑</button>
