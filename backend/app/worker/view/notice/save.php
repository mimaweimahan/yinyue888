    ...
    <form class="layui-form" method="post" action="{:url('save')}">
        ...
        <div class="form-item">
            ...
            <div class="input-block">
                <input type="text" name="title" value="{$title}" id="title" placeholder=" 填写公告标题 " autocomplete="off" class="layui-input" />
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="input-inline">
                <div style="width: 180px">
                    <select name="status" id="status" class="layui-select">
                        ...
                        <option value="1" {if $status == 1} selected {/if}>开启显示</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="input-block">
                <textarea name="note" id="note" placeholder=" 填写公告内容 " class="layui-textarea">{$note}</textarea>
            </div>
        </div>
