...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item"><a href="{:url('index')}">控制台</a></li>
        </ul>
        <ul class="layui-nav layui-layout-right ">
            <li class="layui-nav-item">
                <a href="javascript:void(0);" >
                    <img src="{:url('tool/avatar/index',['uid'=>$admin_info['worker_id']])}" class="layui-nav-img layui-hide-xs">
                    <i class="layui-hide-xs">{$admin_info['nickname']}</i>
                </a>
                <dl class="layui-nav-child">
                    <dd><a href="{:url('worker/index/updated')}" target="main">基本资料</a></dd>
                    <dd><a href="{:url('worker/index/binding')}" target="main">谷歌验证</a></dd>
                    <dd><a href="{:url('worker/login/signout')}">安全退出</a></dd>
                </dl>
            </li>
        </ul>
    </div>
    <div class="left-user-box">
        <a href="{:url('worker/index/updated')}" target="main">
            <img src="{:url('tool/avatar/index',['uid'=>$admin_info['worker_id']])}" class="layui-nav-img">
            <dl>
                <dd>{$admin_info['nickname']}</dd>
                <dt>{$admin_info['worker_user']}</dt>
            </dl>
        </a>
    </div>
