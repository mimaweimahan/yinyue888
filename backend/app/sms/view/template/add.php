...
<div class="panel-default">
    <div class="panel-heading">
        ...
        <ul class="panel-tab">
            ...
            <li class="layui-this"><a>新增模板</a></li>
        </ul>
    </div>
        ...
        <form class="layui-form" method="post" action="{:url('add')}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="template_id" id="template_id" class="layui-input" size="68" placeholder="请填写模板编号">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="template_name" id="template_name" class="layui-input" size="68" placeholder="请填写模板名称">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea type="text" name="content" id="content" class="layui-textarea" placeholder="模板内容"></textarea>
                </div>
            </div>
