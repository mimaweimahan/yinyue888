...
<div class="panel-default">
    <div class="panel-heading">
        ...
        <ul class="panel-tab">
            <li class="layui-this"><a href="{:url('index')}">记录管理</a></li>
            <li><a href="{:url('send')}">发送短信</a></li>
            <li><a href="{:url('sms/template/index')}">短信模版</a></li>
        </ul>
    </div>
    <div class="panel-body">
        <div class="layui-show">
            <div style="height:35px; color:#666;">
                短信余额:{$balance}条, 已使用:{$transactional_balance}条
            </div>
