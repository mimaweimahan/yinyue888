        ...
        <div class="layui-show">
            <div class="layui-card-body" style="padding: 15px;">
                <blockquote class="layui-elem-quote" style="font-size: 14px;">
                    <p>最低提现：<b class="red">{:getConfig('agent_min_tx')}</b> USDT,提现手续费：<b class="red">{:getConfig('agent_tx_rate')}</b> USDT。</p>
                </blockquote>
                <fieldset>
                    <legend>可用余额：<b class="red" style="font-size: 18px">{$balance}</b> USDT</legend>
                    <form class="layui-form layui-form-pane form-search" autocomplete="off">
                        <div class="layui-form-item ">
                            ...
                            <label class="layui-input-inline" style="width: 60%;">
                                <input type="text" name="address" value="{$withdrawal_address}" lay-verify="required" placeholder="请先绑定提现地址" disabled class="layui-input"/>
                            </label>
                        </div>
                        <div class="layui-form-item ">
