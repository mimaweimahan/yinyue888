            ...
            <form class="layui-form" method="post" action="{:url('updated')}">
                <div class="form-item">
                    ...
                    <div class="input-inline">
                        <input type="text"  value="{$agent_id}" id="idd" disabled class="layui-input">
                    </div>
                </div>
                <div class="form-item">
                    <label for="username" class="form-label">登录账号</label>
                    <div class="input-inline">
                        <input type="text" value="{$username}" id="username" disabled class="layui-input">
                    </div>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    ...
                    <div class="input-inline">
                        <input type="text" value="{$rate}" id="rate" disabled class="layui-input">
                    </div>
                </div>
                <div class="form-item">
