...
<script type="text/javascript">
    ...
    // 相关常量
    const ACCOUNT_API = "{:url('agent/admin.wallet/index')}";
    layui.config({
        version:1.0,
        ...
        table.on("tool(table_list)", function (obj) {
                    ...
                    ,click: function(res){
                        ...
                        if (res.id === 'balance'){
                            ...
                            layer.open({
                                ...
                                maxmin: true,
                                area: [is_mobile() ? "100%" : "750px", is_mobile() ? "100%" : "600px"],
                                content: "{:url('agent/admin.pai/index')}?id=" + value,
                            });
            ...
            else if (obj.event === "see")
            {
               ...
               layer.open({
                    ...
                    content: "{:url('xj')}?is_first=1&pid=" + data.id,
                    area: ['90%', '80%'],
                    shadeClose: true,
                    shade: 0.8,
                });
