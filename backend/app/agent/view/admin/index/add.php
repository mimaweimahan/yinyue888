    ...
    <form class="layui-form" method="post" action="{:url('add')}">
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="nickname" id="nickname" placeholder="代理昵称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
            <label for="username" class="form-label">登陆账号</label>
            <div class="input-inline">
                <input type="text" name="username" id="username" placeholder="登陆账号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
            <label for="rate" class="form-label">代理费率</label>
            <div class="input-inline">
                <input type="text" name="rate" value="0.700" id="rate" class="layui-input">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="max_paid_amount" value="0.0000" id="max_paid_amount" placeholder=" 填写0为不限制 " autocomplete="off" class="layui-input" />
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="telegram" id="telegram" placeholder="Telegram客服账号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
