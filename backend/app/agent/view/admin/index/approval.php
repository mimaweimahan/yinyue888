...
<div class="page-package">
    <form class="layui-form" method="post" action="{:url('approval')}">
        ...
        <div class="form-item">
            <label for="rate" class="form-label">审批结果</label>
            <div class="input-inline">
                <div style="width: 180px">
                    <select name="status" id="status" class="layui-select">
                        <option value="0" selected>请选择</option>
                        <option value="1">审批通过并已支付</option>
        ...
        <div class="form-item">
            ...
            <div class="input-block">
                <input type="text" name="mark" id="mark" placeholder=" 填写审批说明 " autocomplete="off" class="layui-input" />
            </div>
        </div>
