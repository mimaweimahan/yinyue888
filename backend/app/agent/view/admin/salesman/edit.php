    ...
    <form class="layui-form" method="post" action="{:url('edit')}">
        ...
        <div class="form-item">
            ...
            <div class="input-block">
                <select name="agent_id" id="agent_id">
                    ...
                    <option value="{$r.agent_id}" {if $agent_id eq $r.agent_id}selected{/if}>{$r.username}</option>
                    {/volist}
                </select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="worker_user" value="{$worker_user}" id="worker_user" placeholder="用户名" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="nickname" value="{$nickname}" id="nickname" placeholder="昵称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
