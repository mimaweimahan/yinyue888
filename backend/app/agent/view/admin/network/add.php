    ...
    <form class="layui-form" method="post" action="{:url('add')}">
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="title"  required lay-verify="required" placeholder="请输入类型标题" autocomplete="off" class="layui-input" />
            </div>
        </div>
        <div class="form-item">
            <label for="title" class="form-label">类型名称</label>
            <div class="input-inline">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="sort" value="0" placeholder="0" autocomplete="off" class="layui-input" />
            </div>
        </div>
