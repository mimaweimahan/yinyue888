...
<div class="page-package">
    <form class="layui-form" method="post" action="{:url('editdz')}">
        ...
        <div class="form-item">
            ...
            <div class="input-block">
                <select name="type_id" id="type_id">
                    ...
                    <option value="{$r.id}" {if $type_id==$r.id} selected {/if} >{$r.title}</option>
                    {/volist}
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="icon" value="{$icon}" id="address_icon" class="layui-input w100" placeholder="点击按钮上传">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="input-block">
                <input type="text" name="address" value="{$address}" placeholder="请填写钱包地址" autocomplete="off" class="layui-input" />
            </div>
        </div>
