<?php /*a:1:{s:58:"/www/wwwroot/tisktshop.com/app/worker/view/login/index.php";i:1762764582;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <style type="text/css">
        html,body{
            height: 100%;
            background: url("/statics//admin/login_bg.jpg") 50% no-repeat #f1f4fd;
    ...
    <div>
        <form class="layui-form" action="" method="post">
            ...
            <div class="form-item">
                ...
                <input type="text" name="user_name" id="user_name"  placeholder="请输入账号" autocomplete="off" class="layui-input">
            </div>
            <div class="form-item">
            ...
            <div class="form-item">
                ...
                <input type="password" name="google_auth" id="google_auth"  placeholder="没有绑定无需填写" autocomplete="off" class="layui-input">
            </div>
            <div class="form-item" id="verify-form" <?php if($verify_lock < 3){ echo 'style="display: none"';} ?> >
                ...
                <div id="verify-box">
                    ...
                    <img src="<?php echo url('tool/verify/index',['w'=>120,'h'=>45,'f'=>15]); ?>" alt="验证码" id="verify_img_url" width="120" height="48"/>
                </div>
            </div>
...
<script type="text/javascript">
    layui.config({
        ...
        $('#verify_img_url').on('click',function () {
            $(this).attr("src","<?php echo url('tool/verify/index',['w'=>120,'h'=>45,'f'=>15]); ?>&num="+Math.random());
        });
                ...
                success:function(data){
                    ...
                    if (data.code ==1) {
                        setInterval(function(){
                            window.location.href = "<?php echo url('worker/index/index'); ?>";
                        },3000);
                    } else{
