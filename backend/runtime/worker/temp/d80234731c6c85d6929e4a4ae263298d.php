<?php /*a:1:{s:57:"/www/wwwroot/tisktshop.com/app/worker/view/index/main.php";i:1762764580;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
			...
			<div class="layui-tab-item layui-show">
                ...
                <div class="think-box-shadow portal-block-container notselect" style="padding:10px;border: 0">
                    <div class="layui-row layui-col-space15" >
                        <div class="layui-col-sm6 layui-col-md3">
                            <div class="portal-block-item nowrap" style="background:linear-gradient(-125deg,#57bdbf,#2f9de2)">
                                <div>在线用户</div>
                                <div><?php echo html_entities($online_user_num); ?></div>
                                <div>当前在线用户数</div>
                            </div>
                        ...
                        <div class="layui-col-sm6 layui-col-md3">
                            <div class="portal-block-item nowrap" style="background: linear-gradient(-125deg,#ff8f7d,#fb522c);">
                                <div>注册用户</div>
                                <div><?php echo html_entities($new_user_num); ?></div>
                                <div>今日新注册用户数</div>
                            </div>
                        ...
                        <div class="layui-col-sm6 layui-col-md3">
                            <div class="portal-block-item nowrap" style="background: linear-gradient(-113deg,#91d843,#739277);">
                                <div>任务人数</div>
                                <div><?php echo html_entities($task_user_num); ?></div>
                                <div>正在执行任务总数</div>
                            </div>
                        ...
                        <div class="layui-col-sm6 layui-col-md3">
                            <div class="portal-block-item nowrap" style="background: linear-gradient(-141deg,#3b7ef9,#b32121);">
                                <div>今日首冲</div>
                                <div><?php echo html_entities($sc_amount); ?></div>
                                <div>首冲人数：<span><?php echo html_entities($sc_user_num); ?></span></div>
                            </div>
                    ...
                    <div class="layui-row layui-col-space15">
                        <div class="layui-col-sm6 layui-col-md3">
                            <div class="portal-block-item nowrap" style="background:linear-gradient(-141deg,#ecca1b,#f39526)">
                                <div>充值总额</div>
                                <div><?php echo html_entities($recharge_amount); ?></div>
                                <div>充值人数：<span><?php echo html_entities($recharge_num); ?></span></div>
                            </div>
                            <i class="portal-block-icon layui-icon layui-icon-dollar"></i>
                        </div>
                        ...
                        <div class="layui-col-sm6 layui-col-md3">
                            <div class="portal-block-item nowrap" style="background: linear-gradient(-125deg,#57bdbf,#2fe2b9);">
                                <div>提现总额</div>
                                <div><?php echo html_entities($withdrawal_amount); ?></div>
                                <div>提现人数：<span><?php echo html_entities($withdrawal_num); ?></span></div>
                            </div>
                            <i class="portal-block-icon layui-icon layui-icon-fire"></i>
                        </div>
                        <div class="layui-col-sm6 layui-col-md3">
                        ...
                        <div class="layui-col-sm6 layui-col-md3">
                            <div class="portal-block-item nowrap" style="background:linear-gradient(-113deg,#c543d8,#925cc3)">
                                <div>今日盈亏</div>
                                <div><?php echo html_entities($day_yk); ?></div>
                    ...
                    <label class="layui-hide">
                        <textarea id="jsondata1"><?php echo html_entities($charts_data); ?></textarea>
                    </label>
...
<script type="text/javascript" src="/statics//extend/require.js"></script>
<script type="text/javascript">
    layui.config({
        ...
        let $ = layui.jquery;
        require(['/statics//extend/echarts.min.js'], function (echarts) {
