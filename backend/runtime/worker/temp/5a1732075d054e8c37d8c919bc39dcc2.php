<?php /*a:1:{s:60:"/www/wwwroot/tisktshop.com/app/worker/view/index/updated.php";i:1762764581;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <form class="layui-form" method="post" action="<?php echo url('updated'); ?>">
                <div class="form-item">
                    ...
                    <div class="input-inline">
                        <input type="text"  value="<?php echo html_entities($worker_id); ?>" id="idd" disabled class="layui-input">
                    </div>
                </div>
                <div class="form-item">
                    <label for="worker_user" class="form-label">登录账号</label>
                    <div class="input-inline">
                        <input type="text" value="<?php echo html_entities($worker_user); ?>" id="worker_user" disabled class="layui-input">
                    </div>
                </div>
                <div class="form-item">
