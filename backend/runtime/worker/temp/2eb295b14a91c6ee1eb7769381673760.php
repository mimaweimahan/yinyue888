<?php /*a:1:{s:57:"/www/wwwroot/tisktshop.com/app/worker/view/user/index.php";i:1764517556;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    // 相关常量
    const ACCOUNT_API = "<?php echo url('worker/wallet/index'); ?>";
    layui.config({
        version:1.0,
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'updated_time', align: 'left', sort:true, title: '活跃信息', width: 190, templet: function(d){
                        ...
                        str += (d.is_online_time  ? '<span class="layui-badge-rim" style="background-color: #dc2fbf; color: #fff;">活跃 </span> ' + d.is_online_time :  '<span class="layui-badge-rim">注册</span>' + d.reg_time) ;
                        return  str;
                    }
                },
                {
                    ...
                    ,click: function(res){
                        if (res.id === 'balance'){
                            ...
                            layer.open({
                                ...
                                maxmin: true,
                                area: [is_mobile() ? "100%" : "750px", is_mobile() ? "100%" : "600px"],
                                content: "<?php echo url('worker/pai/index'); ?>?id=" + value,
                            });
                            ...
                            layer.open({
                                ...
                                maxmin: true,
                                area: [is_mobile() ? "100%" : "750px", is_mobile() ? "100%" : "600px"],
                                content: "<?php echo url('worker/notice/save'); ?>?uid=" + value,
                            });
                        }  else if (res.id === 'edit')  {
                            let value = data.id;
                            layer.open({
