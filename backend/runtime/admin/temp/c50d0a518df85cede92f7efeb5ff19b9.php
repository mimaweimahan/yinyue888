<?php /*a:1:{s:58:"/www/wwwroot/tisktshop.com/app/admin/view/module/index.php";i:1744945181;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    layui.config({
        ...
        table.on('tool(table_list)', function(obj){
            ...
            if(_event === 'uninstall'){
                $.getJSON("<?php echo url('uninstall'); ?>",{'module':data.module}).done(function (data) {
                    layer.msg(data.msg);
                    if(data.code === 1){
                        table.reload('table_list',{});
                    }
        ...
        form.on('checkbox(lock_disabled)', function(e){
            ...
            $.getJSON("<?php echo url('setField'); ?>",{'id':id,'field':'disabled','val':val}).done(function (data) {
                layer.msg(data.msg);
                if(data.code === 1){
                    table.reload('table_list',{});
                }
