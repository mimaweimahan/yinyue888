<?php /*a:1:{s:55:"/www/wwwroot/tisktshop.com/app/admin/view/about/add.php";i:1766957627;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title><?php if(!empty($id)): ?>编辑关于我们<?php else: ?>添加关于我们<?php endif; ?></title>
...
<div class="page-package">
    <form class="layui-form" method="post" action="<?php if(!empty($id)): ?><?php echo url('edit'); else: ?><?php echo url('add'); ?><?php endif; ?>">
        ...
        <?php endif; ?>
        <div class="form-item">
            <label for="content" class="form-label">关于我们内容 <span style="color:red">*</span></label>
            <div class="input-block">
                <textarea name="content" id="content" placeholder="请输入关于我们内容" class="layui-textarea" lay-verify="required" style="min-height:400px"><?php echo html_entities((isset($content) && ($content !== '')?$content:'')); ?></textarea>
            </div>
        </div>
