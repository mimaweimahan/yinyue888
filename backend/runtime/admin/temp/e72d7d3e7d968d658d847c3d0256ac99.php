<?php /*a:1:{s:54:"/www/wwwroot/tisktshop.com/app/admin/view/rule/add.php";i:1661009434;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="page-package">
    <form class="layui-form" method="post" action="<?php echo url('add'); ?>">
        <input type="hidden" name="pid" value="<?php echo html_entities($pid); ?>">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" id="title" placeholder="菜单名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">认证类型</label>
            <div class="layui-input-block">
                <select name="type"  title="选择认证类型">
                    <option value="1">菜单+认证</option>
                    <option value="2">主菜单+认证</option>
                    <option value="0">只为菜单</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" placeholder="权限规则" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="condition" class="layui-form-label">附加规则</label>
            <div class="layui-input-block">
                <input type="text" name="condition" id="condition" placeholder=" 填写附加规则" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">自动完善下级</label>
            <div class="layui-input-block">
                <input type="radio" name="all_add" value="1" title="是" />
                <input type="radio" name="all_add" value="0" title="否" checked="checked"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label for="note" class="layui-form-label">备注说明</label>
            <div class="layui-input-block">
                <input type="text" name="note" id="note" placeholder="备注说明" autocomplete="off" class="layui-input">
            </div>
        </div>
