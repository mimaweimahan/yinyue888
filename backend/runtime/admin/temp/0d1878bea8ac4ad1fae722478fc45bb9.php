<?php /*a:1:{s:59:"/www/wwwroot/tisktshop.com/app/admin/view/admin/binding.php";i:1762837987;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="page-package">
    <form class="layui-form" method="post" action="<?php echo url('binding'); ?>">
        <input type="hidden" name="id" value="<?php echo html_entities($user['id']); ?>"/>
        <div class="form-item">
            <label for="nickname" class="form-label">谷歌验证扫码</label>
            <div class="input-block">
                <img src="<?php echo html_entities($qrCodeUrl); ?>" alt=""/>
            </div>
        </div>
        <div class="form-item">
            <div class="form-item">
                ...
                <div class="input-block">
                    <input type="text" name="secret_key" value="<?php echo html_entities($secret_key); ?>" readonly placeholder="请输入谷歌秘钥" class="layui-input">
                </div>
            </div>
        </div>
