<?php /*a:1:{s:62:"/www/wwwroot/tisktshop.com/app/admin/view/user/index/index.php";i:1767129893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'freeze_balance',align: 'center',title: '交易/差额',width: 95,templet: function(d){
                        return d.freeze_balance + '<hr class="mr5" />' + (d.frozen  ? d.frozen : '-');
                    }},
                {field: 'is_task',align: 'center', title: '抢单开关', toolbar: '#task', width:96},
                ...
                {field: 'is_top',align: 'center', title: '置顶', toolbar: '#is_top', width:88},
            ]]
                    ...
                    ,click: function(res){
                        ...
                        if (res.id === 'balance'){
                            ...
                            layer.open({
                                ...
                                content: "<?php echo url('admin/notice/save'); ?>?uid=" + value,
                            });
                        }  else if (res.id === 'edit')  {
                            let value = data.id;
                            layer.open({
