<?php /*a:1:{s:56:"/www/wwwroot/tisktshop.com/app/admin/view/admin/edit.php";i:1756801171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="page-package">
    <form class="layui-form" method="post" action="<?php echo url('edit'); ?>">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="phone" value="<?php echo html_entities($phone); ?>" id="phone" placeholder="登录账号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="email" class="layui-form-label">邮箱</label>
            <div class="layui-input-block">
                <input type="text" name="email" value="<?php echo html_entities($email); ?>" id="phone" placeholder="登录邮箱" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
