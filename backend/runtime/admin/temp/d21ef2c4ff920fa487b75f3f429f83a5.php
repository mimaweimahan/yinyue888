<?php /*a:1:{s:56:"/www/wwwroot/tisktshop.com/app/admin/view/clause/add.php";i:1766954272;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title><?php if(!empty($id)): ?>编辑条款<?php else: ?>添加条款<?php endif; ?></title>
    ...
    <form class="layui-form" method="post" action="<?php if(!empty($id)): ?><?php echo url('edit'); else: ?><?php echo url('add'); ?><?php endif; ?>">
        ...
        <div class="form-item">
            ...
            <div class="input-block">
                <textarea name="content" id="content" placeholder="请输入条款内容" class="layui-textarea" lay-verify="required" style="min-height:400px"><?php echo html_entities((isset($content) && ($content !== '')?$content:'')); ?></textarea>
            </div>
        </div>
