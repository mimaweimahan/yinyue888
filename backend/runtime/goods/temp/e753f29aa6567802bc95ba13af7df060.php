<?php /*a:1:{s:57:"/www/wwwroot/tisktshop.com/app/goods/view/index/index.php";i:1756622040;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body hide-left">
        ...
        <div class="layui-show">
            <form class="layui-form">
                <input type="hidden" name="type_id" value="<?php echo html_entities($type_id); ?>">
                <ul class="search-box">
...
<script type="text/html" id="toolbar">
    <div class="layui-btn-container">
        <div class="layui-btn-group">
            <a href="<?php echo url('add',['type_id'=>$type_id]); ?>" class="layui-btn layui-btn-sm"><span><i class="layui-icon layui-icon-add-circle"></i>新增</span></a>
...
<script type="text/html" id="set_panel">
    <a href="<?php echo url('edit'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-primary">编辑</a>
        ...
        table.on('toolbar(table_list)', function(obj){
            ...
            if(obj.event === 'move'){
                layer.open({
                    ...
                    maxmin:true,
                    shadeClose: true, //开启遮罩关闭
                    content:"<?php echo url('move'); ?>?ids="+ids,
                    end:function () {
                        table.reload('table_list',{});
                    }
                });
