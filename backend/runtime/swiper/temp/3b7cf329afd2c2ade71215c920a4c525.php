<?php /*a:1:{s:56:"/www/wwwroot/tisktshop.com/app/swiper/view/index/add.php";i:1670943230;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel-default">
    <div class="panel-heading">
        ...
        <ul class="panel-tab">
            <li><a href="<?php echo url('index'); ?>">轮播图列表</a></li>
            <li class="layui-this"><a href="javascript:void(0);">新增轮播图</a></li>
        </ul>
    </div>
        ...
        <form class="layui-form" method="post" action="<?php echo url('add'); ?>">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="title" id="title" class="layui-input" size="68" placeholder="请填写轮播图名称">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="tab" id="tab" class="layui-input" size="68" placeholder="请填写调用标签">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="note" id="note" class="layui-input" size="68" placeholder="请填写轮播图说明">
                </div>
            </div>
                ...
                <div class="layui-input-block">
                    <table class="layui-table">
                        ...
                        <tbody class="swiper-box">
                            <tr>
                                <td><input type="text" name="swiper[name][]" class="layui-input" size="15" placeholder="名称"></td>
                                <td><input type="text" name="swiper[num][]" class="layui-input" size="15" placeholder="编号"></td>
                                <td><input type="text" name="swiper[pic][]" class="layui-input swiper_pic" data-id="swiper_pic" id="swiper_pic" placeholder="图片"></td>
                                <td><input type="text" name="swiper[url][]" class="layui-input" size="10" placeholder="链接地址"></td>
                                <td><button type="button" class="layui-btn layui-btn-sm layui-btn-primary" id="add_swiper"> + 增加 </button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        function upfile(){
            $('.swiper_pic').unbind('click').on('click',function(){
                ...
                layer.open({
                    ...
                    area: ['1020px', '570px'],
                    maxmin:true,
                    content:"<?php echo url('admin/file/api',['num'=>1]); ?>&val="+id,
                    end:function () {}
                });
            });
        }
