<?php /*a:1:{s:58:"/www/wwwroot/tisktshop.com/app/sms/view/template/index.php";i:1661007164;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel-default">
    <div class="panel-heading">
        ...
        <ul class="panel-tab">
            ...
            <li><a href="<?php echo url('add'); ?>">新增模板</a></li>
            <li><a href="<?php echo url('sms/index/index'); ?>">发送记录</a></li>
        </ul>
    </div>
...
<script type="text/html" id="set_panel">
    <a href="<?php echo url('edit'); ?>?id={{d.id}}" class="layui-btn layui-btn-xs layui-btn-primary" lay-event="edit">编辑</a>
