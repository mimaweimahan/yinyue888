<?php /*a:1:{s:64:"/www/wwwroot/tisktshop.com/app/agent/view/admin/repeat/index.php";i:1762764654;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel-default">
    ...
    <div class="panel-body">
        <div class="layui-show">
            <fieldset>
                <legend>号码添加</legend>
                <form class="layui-form layui-form-pane searchForm" lay-filter="table-submit" method="post" action="<?php echo url('add'); ?>"  autocomplete="off">
