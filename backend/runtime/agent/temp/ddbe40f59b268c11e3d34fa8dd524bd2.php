<?php /*a:1:{s:68:"/www/wwwroot/tisktshop.com/app/agent/view/admin/recharge/address.php";i:1762764652;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        table.on('tool(table_list)', function(obj){
            ...
            if(_event === 'del'){
                layer.confirm('确定要删除吗', function(index){
                    $.getJSON("<?php echo url('deldz'); ?>",{'id':id}).done(function (data) {
                        layer.msg(data.msg);
                        if (data.code === 1) {
                            obj.del();
                            layer.close(index);
            ...
            if(_event === 'edit'){
                layer.open({
                    ...
                    area: ['90vw', '600px'],
                    maxmin:true,
                    content:"<?php echo url('editdz'); ?>?id="+id,
                    end:function () {
