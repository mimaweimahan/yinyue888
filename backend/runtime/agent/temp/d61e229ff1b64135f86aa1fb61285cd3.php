<?php /*a:1:{s:66:"/www/wwwroot/tisktshop.com/app/agent/view/admin/recharge/index.php";i:1762777153;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-show">
            <fieldset>
                ...
                <form class="layui-form layui-form-pane searchForm" lay-filter="table-search"  autocomplete="off">
                    ...
                    <div class="layui-form-item layui-inline input-line">
                        <label class="layui-form-label" for="agent_id">代理ID</label>
...
<script type="text/html" id="table-bar">
    {{# if(d.status==0){ }}
    <button type="button" class="layui-btn layui-btn-xs" lay-event="approval">点击审核</button>
    {{# }else{ }}
    <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="approval">已处理</a>
    {{# } }}
</script>
