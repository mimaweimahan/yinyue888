<?php /*a:1:{s:62:"/www/wwwroot/tisktshop.com/app/agent/view/admin/index/edit.php";i:1762764646;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="page-package">
    <form class="layui-form" method="post" action="<?php echo url('edit'); ?>">
        <input type="hidden" name="id" value="<?php echo html_entities($agent_id); ?>">
        <div class="form-item">
            <label for="nickname" class="form-label">代理昵称</label>
            <div class="input-inline">
                <input type="text" name="nickname" value="<?php echo html_entities($nickname); ?>" id="nickname" placeholder="代理昵称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
            <label for="username" class="form-label">登录账号</label>
            <div class="input-inline">
                <input type="text" name="username" value="<?php echo html_entities($username); ?>" id="username" placeholder="登录账号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
            <label for="rate" class="form-label">代理费率</label>
            <div class="input-inline">
                <input type="text" name="rate" value="<?php echo html_entities($rate); ?>" id="rate"  class="layui-input">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="telegram" value="<?php echo html_entities($telegram); ?>" id="telegram" placeholder="Telegram客服账号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
            <label for="password" class="form-label">登录密码</label>
            <div class="input-inline">
                <input type="text" name="password" value="<?php echo html_entities($password); ?>" id="password" placeholder=" 不填写就不更改密码 " autocomplete="off" class="layui-input">
            </div>
        </div>
