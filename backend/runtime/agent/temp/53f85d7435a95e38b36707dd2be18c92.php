<?php /*a:1:{s:63:"/www/wwwroot/tisktshop.com/app/agent/view/admin/index/index.php";i:1762764646;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        table.on('tool(table_list)', function(obj){
            ...
            if(_event === 'rank_up'){
                layer.open({
                    ...
                    maxmin:true,
                    area: ['400px', '480px'],
                    content:"<?php echo url('rankup'); ?>?agent_id="+id,
                    end:function () {
            ...
            if(_event === 'binding'){
                layer.open({
                    ...
                    content:"<?php echo url('binding'); ?>?agent_id="+id,
                    end:function () {
                        table.reload('table_list',{});
                    }
                });
