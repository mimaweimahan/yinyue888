<?php /*a:1:{s:68:"/www/wwwroot/tisktshop.com/app/agent/view/admin/address/recharge.php";i:1762764644;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-lead"><em>充值地址</em></div>
    </div>
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {title: "地址",  field: "address", minWidth: 390,templet: function (d) {
                        return '<span class="layui-badge layui-bg-cyan">' + d.address_type_name + '</span>&nbsp;' + d.address;
                    }},
                {title: "余额",  field: "balance",sort: true,
                    ...
                    templet: function (d) {
                        switch (d.address_type) {
                            case 2:
                                return '<span class="usdt">0</span><hr class="mr5" />' + '<span class="bnb">0</span>';
                            case 1:
                                return '<span class="usdt">0</span><hr class="mr5" />' + '<span class="eth">0</span>';
                            default:
                                return '<span class="usdt">0</span><hr class="mr5" />' + '<span class="trx">0</span>';
                        }
                    }},
        ...
        table.on('tool(table_list)', function(obj){
            ...
            if(_event === 'qrcode'){
                layer.open({
                    ...
                    maxmin: true,
                    area: ["330px","330px"],
                    content:  "<?php echo url('qrcode'); ?>?id=" + id
                });
            }
