<?php /*a:1:{s:70:"/www/wwwroot/tisktshop.com/app/agent/view/admin/address/withdrawal.php";i:1762764645;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-lead"><em>提现地址</em></div>
    </div>
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {title: "地址",  field: "address", minWidth: 390,templet: function (d) {
                        switch (d.withdraw_type) {
                            case 1:
                                return '<span class="layui-badge layui-bg-cyan">ERC20</span>&nbsp;' + d.address;
                            case 2:
                                return '<span class="layui-badge layui-bg-orange">ERC20</span>&nbsp;'+ d.address;
                            case 0:
