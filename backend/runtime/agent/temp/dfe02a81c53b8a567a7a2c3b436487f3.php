<?php /*a:1:{s:69:"/www/wwwroot/tisktshop.com/app/agent/view/admin/recharge/approval.php";i:1762764652;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <div class="input-inline">
                <div style="width: 180px">
                    <select name="status" id="status" class="layui-select">
                        ...
                        <option value="1">审批通过并给用户上分</option>
                        <option value="2">充值无效</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="form-item">
            <label for="remark" class="form-label">审批说明</label>
            <div class="input-block">
                <input type="text" name="remark" id="remark" placeholder=" 填写审批说明 " autocomplete="off" class="layui-input" />
            </div>
        </div>
