<?php /*a:1:{s:57:"/www/wwwroot/tisktshop.com/app/agent/view/index/index.php";i:1757988338;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <ul class="layui-nav layui-layout-right ">
            <li class="layui-nav-item">
                <a href="javascript:void(0);" >
                    <img src="<?php echo url('tool/avatar/index',['uid'=>$admin_info['agent_id']]); ?>" class="layui-nav-img layui-hide-xs">
                    <i class="layui-hide-xs"><?php echo html_entities($admin_info['nickname']); ?></i>
                </a>
                <dl class="layui-nav-child">
                    <dd><a href="<?php echo url('agent/index/updated'); ?>" target="main">基本资料</a></dd>
                    <dd><a href="<?php echo url('agent/index/binding'); ?>" target="main">谷歌验证</a></dd>
                    <dd><a href="<?php echo url('agent/login/signout'); ?>">安全退出</a></dd>
                </dl>
            </li>
        </ul>
    </div>
    <div class="left-user-box">
        <a href="<?php echo url('agent/index/updated'); ?>" target="main">
            <img src="<?php echo url('tool/avatar/index',['uid'=>$admin_info['agent_id']]); ?>" class="layui-nav-img">
            <dl>
                <dd><?php echo html_entities($admin_info['nickname']); ?></dd>
                <dt><?php echo html_entities($admin_info['username']); ?></dt>
            </dl>
        </a>
    </div>
