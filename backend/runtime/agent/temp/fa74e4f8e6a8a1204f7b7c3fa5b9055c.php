<?php /*a:1:{s:62:"/www/wwwroot/tisktshop.com/app/agent/view/sys/salesman/add.php";i:1762764602;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form" method="post" action="<?php echo url('add'); ?>">
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="worker_user" id="worker_user" placeholder="登陆账户" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="input-inline">
                <input type="text" name="nickname" id="nickname" placeholder="请填写用户昵称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="form-item">
